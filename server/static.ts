...
const faqSchemas: Record<string,string> = {"/uslugi/vyshivka":"<script type=\"application/ld+json\">{\"@context\":\"https://schema.org\",\"@type\":\"FAQPage\",\"mainEntity\":[{\"@type\":\"Question\",\"name\":\"Сколько стоит вышивка логотипа на одежде?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Цена зависит от тиража, сложности логотипа и количества цветов. Ориентировочно: от 1 500 ₸ за изделие при заказе 1–49 шт, от 500 ₸ при тираже 50–499 шт и от 350 ₸ при заказе от 500 шт. Точную стоимость рассчитываем по вашему макету за 30 минут.\"}},{\"@type\":\"Question\",\"name\":\"От какого количества можно заказать вышивку?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"От 1 штуки — минимального тиража нет. Большие партии — со скидкой до 30%.\"}},{\"@type\":\"Question\",\"name\":\"Сколько времени занимает изготовление?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Стандартный срок — 5–7 рабочих дней после утверждения макета. Срочный заказ — от 3 рабочих дней.\"}},{\"@type\":\"Question\",\"name\":\"Можно ли сделать вышивку на спецодежде?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Да, это одно из ключевых направлений. Вышивка выдерживает более 100 стирок и сложные условия, поэтому идеальна для спецодежды: жилетов, курток, комбинезонов.\"}},{\"@type\":\"Question\",\"name\":\"Вы делаете вышивку на кепках, футболках и поло?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Да. Вышиваем на кепках, футболках, поло, худи, свитшотах, куртках, рубашках, жилетах и сумках. Можем работать с вашими изделиями или пошить одежду с нуля.\"}},{\"@type\":\"Question\",\"name\":\"Чем вышивка лучше печати?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Вышивка держится весь срок службы изделия — не выцветает и не смывается, тогда как печать выдерживает 20–60 стирок. Выглядит дороже и статуснее.\"}},{\"@type\":\"Question\",\"name\":\"Что такое 3D-вышивка?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Это объёмная вышивка, при которой логотип выступает над тканью. Эффектнее всего смотрится на кепках и поло. Стоит от 550 ₸ за изделие.\"}},{\"@type\":\"Question\",\"name\":\"Сколько стоит оцифровка логотипа?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"При заказе от 50 изделий — бесплатно. При меньшем тираже — от 5 000 ₸. Готовый файл остаётся у вас навсегда.\"}},{\"@type\":\"Question\",\"name\":\"Можно заказать пробный образец перед тиражом?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Да. При заказе от 200 штук делаем одно пробное изделие бесплатно.\"}},{\"@type\":\"Question\",\"name\":\"Вы работаете с юрлицами? Есть договор и НДС?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Да, работаем официально с юрлицами и ИП. Договор, счёт, акт и счёт-фактура с НДС.\"}},{\"@type\":\"Question\",\"name\":\"Доставляете в другие города Казахстана?\",\"acceptedAnswer\":{\"@type\":\"Answer\",\"text\":\"Да. Производство в Алматы, доставляем по всему Казахстану — Астана, Шымкент, Караганда, Актобе и другие города.\"}}]}</script>"};
...
function getMetaForPath(urlPath: string, query: string): { title: string; description: string; canonical: string } {
  ...
  if (urlPath.startsWith("/uslugi/vyshivka")) return { title: "Вышивка логотипа на одежде в Алматы — от 1 шт | ZERO PRINT", description: "Машинная и 3D вышивка логотипа на поло, худи, кепках, спецодежде. От 1 штуки, срок от 3 дней. Не выцветает, выдерживает 100+ стирок. Доставка по Казахстану. Цена от 350 ₸.", canonical: `${base}/uslugi/vyshivka` };
...
export function serveStatic(app: Express) {
  ...
  app.use("/{*path}", (req, res) => {
    ...
    const __faq = faqSchemas[u.pathname]; if (__faq) result = result.replace("</head>", __faq + "</head>");
    res.send(result);
  });
}
